...
# 直接设置参数
#C:\Users\15401\Desktop\yolo_iron\labels
json_dir = 'C:/Users/15401/Desktop/yolo_iron/labels'  # 替换为你的JSON文件目录
save_dir = 'C:/Users/15401/Desktop/yolo_iron/labels_trans'  # 替换为你想要保存TXT文件的目录
classes = 'ungrip,grip'  # 替换为你的类别名称，用逗号分隔
